...
if rank == 0:
    ...
    # load weights
    model.load_weights("./chkpts/init_mobilenet.ckpt")
    ...
    exp_name = "_fp32_"
    train_log_dir = 'logs/mobilenet'+exp_name+str(rank)+'/' + current_time + '/train'
    test_log_dir = 'logs/mobilenet'+exp_name+str(rank)+'/' + current_time + '/test'
